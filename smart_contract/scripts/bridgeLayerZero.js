...
exports.script = {
  ...
  async main(params, signer) {
    ...
    const deployed1 = await LZero1.connect(signer).deploy(destChainId2.chainId, destChainId1.endpoint, supply, short_name, long_name);
    ...
    const deployed2 = await lz.deploy(LZero2, signer2, [destChainId1.chainId, destChainId2.endpoint, supply, short_name, long_name])
